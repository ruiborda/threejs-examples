...
export default function globe_manipulator(params) {
    ...
    var _camera_position = {x:0.0, y:0.0, z:0.0};
    var _mouse_pos_on_down = {x:0, y:0 };
    var _target_on_down = {x:0.0, y:0.0};
    ...
    var _rotation = {x:0.0, y:0.0};
    var _target = {x:0.0, y:0.0};

    var motion_scaling_factor = 10.0;
    var _smoothing_factor = 0.1;
    var _wheel_scaling = 0.5;
    ...
    function _on_mouse_move(event) {
        ...
        // if using right click to select and triyng to use it for move, just return
        if ( _right_click_to_select && event.button == 2 ) {
            return;
        }
